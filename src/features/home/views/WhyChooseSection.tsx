  ...
  return (
    <section id="why-partner" className="ae-section border-b border-white/10 py-12 sm:py-14">
      <div className="ae-container grid gap-8 lg:grid-cols-[0.82fr_1.18fr] lg:items-center">
        ...
        <div className="ae-glass grid gap-0 overflow-hidden rounded-lg sm:grid-cols-2 lg:grid-cols-4">
          {benefits.map((benefit) => (
            <article
              key={benefit.title}
              className="ae-value-item group border-white/10 px-5 py-8 text-center sm:border-l"
            >
