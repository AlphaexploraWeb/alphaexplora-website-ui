    ...
    <section className="relative min-h-screen w-full flex flex-col items-center justify-center bg-transparent pointer-events-none overflow-hidden">
      ...
      >
        <motion.h1 className="flex flex-col items-center uppercase mix-blend-screen drop-shadow-2xl">
          ...
          <motion.span variants={itemVariants} className="text-[clamp(3.5rem,12vw,7rem)] lg:text-[7.5rem] xl:text-[8.5rem] font-black tracking-tighter leading-[0.9] md:leading-none text-transparent bg-clip-text bg-gradient-to-b from-white via-blue-100 to-blue-600 drop-shadow-[0_0_40px_rgba(59,130,246,0.8)] pb-2">
            Agentic AI
          </motion.span>
        </motion.h1>
