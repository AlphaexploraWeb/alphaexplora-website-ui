...
import stPeterLogo from '../../../assets/PETER.png';
...
const clients = [
  ...
  { name: "ST. PETER", logo: stPeterLogo, size: "h-25 md:h-35" },
  ...
  return (
    <section className="relative w-full py-12 md:py-16 overflow-hidden border-y border-white/5 bg-[#010314]/80 backdrop-blur-sm pointer-events-auto z-10">
      ...
      <div className="flex flex-col items-center mb-8 md:mb-12 relative z-20">
        <span className="text-[10px] md:text-xs font-mono text-cyan-500/80 tracking-[0.3em] uppercase mx-[25px] text-center">Provided value for our following partners</span>
      </div>
